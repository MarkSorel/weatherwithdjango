...
def home(request):
    ...
    if request.method == "POST":
        ...
        api_request = requests.get('http://www.airnowapi.org/aq/observation/zipCode/current/?format=application/json&zipCode=' + zipcode + '&distance=5&API_KEY=66A06ADB-B17E-43EB-BE4B-673C128BCC35')
        ...
        api_request = requests.get("http://www.airnowapi.org/aq/observation/zipCode/current/?format=application/json&zipCode=89129&distance=5&API_KEY=66A06ADB-B17E-43EB-BE4B-673C128BCC35")
